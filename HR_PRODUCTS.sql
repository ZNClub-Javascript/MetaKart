...
INSERT INTO HR.PRODUCTS (ID, NAME, DESCRIPTION, PRICE, IMAGE, STOCK, CATEGORY) VALUES (135, 'Silver Mirror cube', 'The cube twist mirror blocks is a popular 3x3x3 shapemod in which the dimensions of the pieces determine where it must go in a solved state. This allows it to achieve many weird shapes.', 100, 'img/products/cube.jpg', 35, 'games');